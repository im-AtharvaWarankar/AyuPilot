...
export function getAuthToken(): string | null {
  // HARDCODED TOKEN FOR TESTING - Replace with localStorage in production
  return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzYxMjE0NzMwLCJpYXQiOjE3NjExMjgzMzAsImp0aSI6IjE5NmQxNDRhMmJhZTRkYTlhY2RhZDhkMjVhM2Y2Mzk5IiwidXNlcl9pZCI6ImUyMjJkM2JjLTFiYjYtNDU0OS04YmY3LWQ5MGYwNGJkNTI0ZSJ9.4UQ1fNbAniFIgvw8vGk7u1NNtAkL-ol191yvGvG1FXQ';
